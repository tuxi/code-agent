...
// The transcript viewport scrolls on mouse wheel events (run.go enables
// program-level mouse capture with tea.WithMouseCellMotion). The bubbles
// viewport handles tea.MouseMsg wheel buttons natively with a 3-line delta.
