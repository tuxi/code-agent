...
| **Three-layer tool system** | Text (`list_files`, `read_file`, `grep`), Structure (`edit_file`, `apply_patch`, `git_diff`), Cross-session (`send_to_session`) plus policy-gated shell (`run_command`).                                                                                                                                                                   |
